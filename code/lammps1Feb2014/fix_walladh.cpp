...
// void FixWallAhd::setup(int vflag)
// {
...
// void FixWallAhd::post_force_respa(int vflag, int ilevel, int iloop)
// {
...
// void FixWallAhd::hooke(double rsq, double dx, double dy, double dz,
...
// void FixWallAhd::hooke_history(double rsq, double dx, double dy, double dz,
//                                 double *vwall, double *v,
//                                 double *f, double *omega, double *torque,
...
// void FixWallAhd::hertz_history(double rsq, double dx, double dy, double dz,
//                                 double *vwall, double *v,
//                                 double *f, double *omega, double *torque,
//                                 double radius, double mass, double *shear)
// {
...
// double FixWallAhd::memory_usage()
// {
//   int nmax = atom->nmax;
...
// void FixWallAhd::grow_arrays(int nmax)
// {
...
// void FixWallAhd::copy_arrays(int i, int j, int delflag)
// {
//   shear[j][0] = shear[i][0];
//   shear[j][1] = shear[i][1];
//   shear[j][2] = shear[i][2];
...
// void FixWallAhd::set_arrays(int i)
// {
//   shear[i][0] = shear[i][1] = shear[i][2] = 0.0;
// }
...
// int FixWallAhd::pack_exchange(int i, double *buf)
// {
//   buf[0] = shear[i][0];
//   buf[1] = shear[i][1];
//   buf[2] = shear[i][2];
...
// int FixWallAhd::unpack_exchange(int nlocal, double *buf)
// {
...
// int FixWallAhd::pack_restart(int i, double *buf)
// {
//   int m = 0;
//   buf[m++] = 4;
//   buf[m++] = shear[i][0];
...
// void FixWallAhd::unpack_restart(int nlocal, int nth)
// {
