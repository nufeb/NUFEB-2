...
CommandStyle(read_data_ibm,ReadDataIBM)

#else

#ifndef LMP_READ_DATA_IBM_H
#define LMP_READ_DATA_IBM_H
...
class ReadDataIBM : protected Pointers {
 public:
  ReadDataIBM(class LAMMPS *);
  ~ReadDataIBM();
