...
ReadDataIBM::ReadDataIBM(LAMMPS *lmp) : Pointers(lmp)
{
...
void ReadDataIBM::command(int narg, char **arg)
{
...
void ReadDataIBM::bonds(int firstpass)
{
  if (me == 0) {
    if (firstpass) {
...
void ReadDataIBM::angles(int firstpass)
{
  if (me == 0) {
    if (firstpass) {
...
void ReadDataIBM::dihedrals(int firstpass)
{
  if (me == 0) {
    if (firstpass) {
...
void ReadDataIBM::impropers(int firstpass)
{
  if (me == 0) {
    if (firstpass) {
...
void ReadDataIBM::bonus(bigint nbonus, AtomVec *ptr, const char *type)
{
  int i,m,nchunk,eof;
...
void ReadDataIBM::bodies(int firstpass)
{
...
void ReadDataIBM::anglecoeffs(int which)
{
  char *next;
...
void ReadDataIBM::dihedralcoeffs(int which)
{
  char *next;
...
void ReadDataIBM::impropercoeffs(int which)
{
  char *next;
...
void ReadDataIBM::fix(int ifix, char *keyword)
{
  int nchunk,eof;
...
int ReadDataIBM::reallocate(int **pcount, int cmax, int amax)
{
  int *count = *pcount;
...
void ReadDataIBM::open(char *file)
{
  compressed = 0;
...
void ReadDataIBM::parse_keyword(int first)
{
  int eof = 0;
...
void ReadDataIBM::skip_lines(bigint n)
{
  if (me) return;
  char *eof;
...
void ReadDataIBM::parse_coeffs(char *line, const char *addstr, int dupflag)
{
  char *ptr;
  if (ptr = strchr(line,'#')) *ptr = '\0';
