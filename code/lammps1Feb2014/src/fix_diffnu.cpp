...
FixDiffNu::FixDiffNu(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg)
{
...
void FixDiffNu::setup(int vflag)
{
  setup_bins();
  end_of_step();
}
...
double FixDiffNu::compute_array(int i, int j)
{
...
void FixDiffNu::reset_timestep(bigint ntimestep)
{
