...
CommandStyle(read_data_bio,ReadDataBIO)

#else

#ifndef LMP_READ_DATA_BIO_H
#define LMP_READ_DATA_BIO_H
...
class ReadDataBIO : protected Pointers {
 public:
  ReadDataBIO(class LAMMPS *);
  ~ReadDataBIO();
