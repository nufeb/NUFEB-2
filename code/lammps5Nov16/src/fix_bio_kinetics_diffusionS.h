...
FixStyle(kinetics/diffusionS,FixKineticsDiffusionS)
...
class FixKineticsDiffusionS: public Fix {

 public:
  FixKineticsDiffusionS(class LAMMPS *, int, char **);
  ~FixKineticsDiffusionS();
  int setmask();
  void init();
