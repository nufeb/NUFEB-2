...
FixStyle(kinetics/diffusionM,FixKineticsDiffusionM)

#else

#ifndef SRC_FIX_KINETICS_DIFFUSIONM_H
...
class FixKineticsDiffusionM : public Fix {

 public:
  FixKineticsDiffusionM(class LAMMPS *, int, char **);
  ~FixKineticsDiffusionM();
  int setmask();
  void init();
