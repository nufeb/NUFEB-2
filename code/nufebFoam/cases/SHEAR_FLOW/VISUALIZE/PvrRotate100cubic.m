...
fprintf(fid,'light_source{<-10e-2,80e-2,-200e-2> color rgb <0.77,0.75,0.75>}\n');
fprintf(fid,'light_source{<10e-2,80e-2,-200e-2> color rgb <0.57,0.55,0.55>}\n');
