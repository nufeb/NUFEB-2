...
#declare b_z=0.05;
object{ 
Wire_Box(<b_x, b_y, -b_z>, <-b_x, -b_y, -b_z>, 0.002, 0) 
 texture{ pigment{ color rgb<1,1,1>}}
}
// White background
background{rgb 1}
// Two lights with slightly different colors
light_source{<-10e-2,80e-2,-200e-2> color rgb <0.77,0.75,0.75>}
light_source{<10e-2,80e-2,-200e-2> color rgb <0.57,0.55,0.55>}
