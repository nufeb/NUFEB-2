...
(
    DataType& inList, //attribute of each OF local atom
    List<DataType>& outList,
    labelList listSizeList, // atom size in each LP proc
...
void softParticleCloud::ConstructParticle
(
   vector pos,
   vector velo,
   double d,
