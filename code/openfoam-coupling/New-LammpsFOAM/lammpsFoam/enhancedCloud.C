...
void  enhancedCloud::updateDragOnParticles()
{
    ...
    )
    {
        ...
        // Info<< "The initial force on the particle is: " << pDrag_[particleI] << endl;
        ...
        if (particleDragFlag_)
        {
            pDrag_[particleI] +=
               ...
               *p.Vol()*Uri_[particleI];        // Drag
                // Info<< "The drag force is: " << pDrag_[particleI] << endl;
        }
        if (particlePressureGradFlag_)
        {
            ...
            if (particlePressureGradFlag_ == 1)
            {
                ...
                // Info<< "The static pressure gradient force is: "
                //     << -gravity_*rhob_*p.Vol() << endl;
                // Info<< "The dynamic pressure gradient force is: "
                //     << -gradpVec*p.Vol() + gravity_*rhob_*p.Vol() << endl;
            }
