...
#include "SyamlalOBrienCorrectionFactor.H"
...
namespace Foam
{
    defineTypeNameAndDebug(SyamlalOBrienCorrectionFactor, 0);

    addToRunTimeSelectionTable
    (
        dragModel,
        SyamlalOBrienCorrectionFactor,
        dictionary
    );
}
...
Foam::SyamlalOBrienCorrectionFactor::SyamlalOBrienCorrectionFactor
(
...
Foam::tmp<Foam::scalarField> Foam::SyamlalOBrienCorrectionFactor::Jd
(
...
) const
{
    ...
    {
        FatalErrorIn("SyamlalOBrienCorrectionFactor::Jd() ")
    ...
    tmp<scalarField> interCoeff = 0.75*Cds*rhof_*Ur/(pd_*sqr(Vr));

    scalar aveD_ = 0.0022;
    scalarField aveRe = max(Ur*aveD_/nuf_, scalar(1.0e-3));

    scalarField& KinterCoeff = interCoeff();

    forAll(beta, particleJ)
    {
       KinterCoeff[particleJ] = (beta[particleJ]*pd_[particleJ]/aveD_ + (1.0 - beta[particleJ])*sqr(pd_[particleJ]/aveD_) + 0.064*beta[particleJ]*pow(pd_[particleJ]/aveD_,3))*interCoeff()[particleJ];
    }

      

#ifdef DEBUG_JD
    Info<< " ==Report====> " << "SyamlalOBrienCorrectionFactor::Jd()  " << endl;
//    Info<< "Lagrangian A: " << Ai
//        << "Lagrangian B:" << Bi
//        << "Lagrangian rho: " << rhof_
//        << "Lagrangian nu: " << nuf_
//        << "Lagrangian pd: " << pd_
    Info<< "Lagrangian alpha: " << alpha_
//        << "Lagrangian Re: " << Re
//        << "Lagrangian Ur:" << Ur
//        << "Lagrangian Vr: " << Vr
//        << "Lagrangian Cds: " << Cds
