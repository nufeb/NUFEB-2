...
FixStyle(nufeb/property/ancestor,FixPropertyAncestor)

#else

#ifndef LMP_FIX_PROPERTY_ANCESTOR_H
#define LMP_FIX_PROPERTY_ANCESTOR_H

#include "fix_property.h"

namespace LAMMPS_NS {

class FixPropertyAncestor : public FixProperty {
 public:

  FixPropertyAncestor(class LAMMPS *, int, char **);
  virtual ~FixPropertyAncestor() {};
