...
colnames(mat)=c("Lon","Lat","tropical_cereal","pulses","temperate_root","soybean","ini_cereal","ini_pulses","ini_root","ini_soybean")
...
colnames(crp)=c("tropical cereal","pulses","temperate root","soybeans","ini_tropical_cereal","ini_pulses","ini_temperate root","ini_soybeans")
