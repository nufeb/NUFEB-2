...
if(j==0) {
j=1
source("irrigated2/input_irri.R",echo=FALSE)
if(fertilization==0){
fert=3
} else {
if(fertilization==1) {
...
#save(my_crop,file=paste(dirname,"crop"),sep="/")
#write.csv(my_crop,file=paste(dirname,sub("rcp",rcp,(sub("man",man,(sub("fertilization",fertilization,"cccma_crop_fertilization_man_rcp")))))),sep="/"),row.names=FALSE)

#write.csv(result_model,file=paste(dirname,sub("v3",v3,(sub("j",j+1,(sub("j",j,"crop_j_j_v3
