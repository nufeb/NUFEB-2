...
########
if(type=="rainfed"){
source("irrigated2/climgen5C.R",echo=F)
} else {
source("irrigated2/climgen5C.R",echo=F)
}
setwd(new_dir)
...
myp3=rbind(predd1,predd2,predd3,predd4,predd5,predd6,predd7)
...
myp1=rbind(predd1,predd2,predd3,predd4,predd5,predd6,predd7)
...
had_on_irri=list(h1,h2,h3,h4)
 
save(had_on_irri,file=paste(dirname,"had_on_irri",sep="/"))
