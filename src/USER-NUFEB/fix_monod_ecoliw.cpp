...
FixMonodEcoliW::FixMonodEcoliW(LAMMPS *lmp, int narg, char **arg) :
...
void FixMonodEcoliW::update_cells()
{
...
void FixMonodEcoliW::update_atoms()
{
  double **x = atom->x;
