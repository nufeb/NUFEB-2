...
FixStyle(nufeb/property/generation,FixPropertyGeneration)

#else

#ifndef LMP_FIX_PROPERTY_GENERATION_H
#define LMP_FIX_PROPERTY_GENERATION_H

#include "fix_property.h"

namespace LAMMPS_NS {

class FixPropertyGeneration : public FixProperty {
 public:
