...
ComputeStyle(bio/pressure,ComputeNufebPressure)

#else

#ifndef LMP_COMPUTE_NUFEB_PRESSURE_H
#define LMP_COMPUTE_NUFEB_PRESSURE_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeNufebPressure : public Compute {
 public:
  ComputeNufebPressure(class LAMMPS *, int, char **);
  virtual ~ComputeNufebPressure();
  void init();
