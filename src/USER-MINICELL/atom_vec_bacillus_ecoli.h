...
AtomStyle(bacillus/ecoli,AtomVecBacillusEcoli)

#else

#ifndef LMP_ATOM_VEC_BACILLUS_ECOLI_H
#define LMP_ATOM_VEC_BACILLUS_ECOLI_H

#include "atom_vec_bacillus.h"

namespace LAMMPS_NS {

class AtomVecBacillusEcoli : public AtomVecBacillus {
 public:
  struct Bonus {
    double quat[4];
    double inertia[3];
  ...
  AtomVecBacillusEcoli(class LAMMPS *);
  ~AtomVecBacillusEcoli();
