...
#define MAXPLASMID = 10

enum{SPHERE,ROD};       // also in DumpImage
/* ---------------------------------------------------------------------- */

AtomVecBacillusEcoli::AtomVecBacillusEcoli(LAMMPS *lmp) : AtomVecBacillus(lmp)
{
...
AtomVecBacillusEcoli::~AtomVecBacillusEcoli()
{
  memory->sfree(bonus);
}
...
void AtomVecBacillusEcoli::process_args(int narg, char **arg)
{
  if (narg != 0 && narg != 1)
...
void AtomVecBacillusEcoli::init()
{
  AtomVec::init();
...
void AtomVecBacillusEcoli::grow_pointers()
{
  radius = atom->radius;
...
void AtomVecBacillusEcoli::grow_bonus()
{
...
void AtomVecBacillusEcoli::copy_bonus(int i, int j, int delflag)
{
...
void AtomVecBacillusEcoli::copy_bonus_all(int i, int j)
{
...
void AtomVecBacillusEcoli::clear_bonus()
{
  nghost_bonus = 0;
...
int AtomVecBacillusEcoli::pack_comm_bonus(int n, int *list, double *buf)
{
  int i,j,m;
  double *quat;
...
void AtomVecBacillusEcoli::unpack_comm_bonus(int n, int first, double *buf)
{
  int i,m,last;
  double *quat;
...
int AtomVecBacillusEcoli::pack_border_bonus(int n, int *list, double *buf)
{
  int i,j,m;
...
int AtomVecBacillusEcoli::unpack_border_bonus(int n, int first, double *buf)
{
  int i,j,m,last;
  double *quat,*inertia,*pole1,*pole2;
...
int AtomVecBacillusEcoli::pack_exchange_bonus(int i, double *buf)
{
  int m = 0;
...
int AtomVecBacillusEcoli::unpack_exchange_bonus(int ilocal, double *buf)
{
  int m = 0;
...
int AtomVecBacillusEcoli::size_restart_bonus()
{
  int i;
...
int AtomVecBacillusEcoli::pack_restart_bonus(int i, double *buf)
{
  int m = 0;
...
int AtomVecBacillusEcoli::unpack_restart_bonus(int ilocal, double *buf)
{
  int m = 0;
...
void AtomVecBacillusEcoli::data_atom_bonus(int m, char **values)
{
  if (bacillus[m])
...
double AtomVecBacillusEcoli::memory_usage_bonus()
{
  double bytes = 0;
...
void AtomVecBacillusEcoli::create_atom_post(int ilocal)
{
...
void AtomVecBacillusEcoli::data_atom_post(int ilocal)
{
...
void AtomVecBacillusEcoli::pack_data_pre(int ilocal)
{
...
void AtomVecBacillusEcoli::pack_data_post(int ilocal)
{
  bacillus[ilocal] = bacillus_flag;
...
int AtomVecBacillusEcoli::pack_data_bonus(double *buf, int /*flag*/)
{
  int i,j,m;
...
void AtomVecBacillusEcoli::write_data_bonus(FILE *fp, int n, double *buf, int /*flag*/)
{
  int i = 0;
  while (i < n) {
    fmt::print(fp,"{} {} {} {} {} {} {} {} {} {} {}\n",ubuf(buf[i]).i,
...
void AtomVecBacillusEcoli::set_bonus(int m, double *pole1, double diameter, double *quat, double *inertia)
{
  if (bacillus[m])
...
------------------------------------------------------------------------- */
void AtomVecBacillusEcoli::get_pole_coords(int m, double *xp1, double *xp2)
{
  if (bacillus[m] < 0)
    error->one(FLERR,"Assigning bacillus parameters to non-bacillus atom");
